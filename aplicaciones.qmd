...
The list of all available apps can be [found here](https://github.com/fhernanb/semilleroApps) and correspond to the folder names as shown in the following figure:
